...
# train
python argparse_ray_main.py --lrs 0.001 --GPUs 0,1,3,4,5,6,7 --n_GNN_layers 7 --temps 0.4 --IsingMode RB_iid_small --EnergyFunction MIS --N_anneal 2000  --n_diffusion_steps 4 --batch_size 12 --n_basis_states 7 --noise_potential bernoulli --project_name RB_small --seed 123 
