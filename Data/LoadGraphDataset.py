...
class SolutionDatasetLoader:
    ...
    def dataloaders(self):
        ...
        dataloader_train = DataLoader(self.dataset_train, batch_size=self.batch_size, collate_fn=collate_function, num_workers=self.num_workers, shuffle=True, worker_init_fn=seed_worker, generator=generator) if TRAIN_DATASET else None
