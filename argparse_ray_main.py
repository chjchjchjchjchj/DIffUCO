...
parser.add_argument('--IsingMode', default='RB_iid_100', choices = ["Gset","BA_large","RB_iid_small", "RB_iid_dummy", "BA_dummy", "RB_iid_large" ,"RRG_200_k_=all", "BA_small", "COLLAB", "IMDB-BINARY", "RB_iid_100_dummy" , "RB_iid_200", "RB_iid_100", "KS_iid_1000", "KS_3_1000", "KS_3_1000_2000", "KS_one_3_1000", "KS_5_5000", "KS_d_re_5000"], help='Define the Training dataset')
...
parser.add_argument('--stop_epochs', default=1000, type = int, help='define early stopping')
parser.add_argument('--n_diffusion_steps', default=[10], type = int, help='define number of diffusion steps', nargs = "+")
...
parser.add_argument('--minib_diff_steps', default=3, type = int, help='minibatch size in diffusion steps in PPO or forward KL')
# parser.add_argument('--minib_basis_states', default=10, type = int, help='minibatch size in basis states in PPO or forward KL')
parser.add_argument('--minib_basis_states', default=4, type = int, help='minibatch size in basis states in PPO or forward KL')
